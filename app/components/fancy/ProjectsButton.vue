...
<template>
	<NuxtLink :to="to" class="Projects-Button">
		<span class="IconContainer">
			<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 259 259" class="svgBG">
				<circle stroke-width="7" stroke="#fff" r="69" cy="129.5" cx="129.5"/>
				...
				<line stroke-width="8" stroke="#fff" y2="78.7279" x2="79.3848" y1="63.1716" x1="63.8284"/>
				<line stroke-width="8" stroke="#fff" y2="194.728" x2="195.385" y1="179.172" x1="179.828"/>
				<line stroke-width="8" stroke="#fff" y2="58" x2="130" y1="36" x1="130"/>
				<line stroke-width="8" stroke="#fff" y2="64.1715" x2="194.314" y1="78.3137" x1="180.172"/>
				<line stroke-width="8" stroke="#fff" y2="180.172" x2="78.3137" y1="194.314" x1="64.1716"/>
				<line stroke-width="8" stroke="#fff" y2="223" x2="130" y1="201" x1="130"/>
				<line stroke-width="8" stroke="#fff" y2="129" x2="223" y1="129" x1="201"/>
				<line stroke-width="8" stroke="#fff" y2="129" x2="58" y1="129" x1="36"/>
			</svg>

			<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 110 110" class="svgFG">
				<circle stroke-width="28" stroke="#fff" r="32" cy="55" cx="55"/>
